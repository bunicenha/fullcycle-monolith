...
describe("Invoice Repository test", () => {
  ...
  it("should find an invoice", async () => {
    ...
    expect(Math.abs(result.createdAt.getTime() - invoiceReloaded.createdAt.getTime())).toBeLessThan(1000)
    expect(Math.abs(result.updatedAt.getTime() - invoiceReloaded.updatedAt.getTime())).toBeLessThan(1000)
  })
})
